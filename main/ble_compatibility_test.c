...
#define SAMPLE_DEVICE_NAME          "SPICY_SALE_50%"
...
static uint8_t raw_adv_data[] = {
        ...
        0x03, 0x03, 0xFF, 0x00,
        /* device name */
        0x0E, 0x09, 'S','P', 'I', 'C','Y','_','S','A','L','E','_','5','0','%',
        0x02, 0x01, 0x1A, // Manufacturer Specific Data AD type
        0x03, 0xFF, 0x50, 0x25 // Giá trị khuyến mãi (50%)
};
